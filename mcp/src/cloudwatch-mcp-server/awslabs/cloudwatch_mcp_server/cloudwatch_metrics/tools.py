...
class CloudWatchMetricsTools:
    ...
    async def get_metric_data(
        self,
        ctx: Context,
        namespace: Annotated[str, Field(description="The namespace of the metric (e.g., 'AWS/EC2')")],
        metric_name: Annotated[str, Field(description="The name of the metric (e.g., 'CPUUtilization')")],
        ...
        dimensions: Annotated[
            List[Dimension],
            Field(description='List of dimensions that identify the metric'),
        ] = [],
        end_time: Annotated[
    ...
    async def get_metric_metadata(
        ...
        namespace: Annotated[
            str,
            Field(description="The namespace of the metric (e.g., 'AWS/EC2', 'AWS/Lambda')"),
        ],
        metric_name: Annotated[
            str,
            Field(description="The name of the metric (e.g., 'CPUUtilization', 'Duration')"),
        ],
    ...
    async def get_recommended_metric_alarms(
        ...
        dimensions: Annotated[
            List[Dimension],
            Field(description='List of dimensions that identify the metric, each with name and value'),
        ] = [],
        region: Annotated[
            str | None,
            Field(
